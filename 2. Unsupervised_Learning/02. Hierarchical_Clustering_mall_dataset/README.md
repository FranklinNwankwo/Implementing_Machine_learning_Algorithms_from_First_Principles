...
```
02. Hierarchical_Clustering_mall_dataset/
├── notebook/
...
cd "Implementing_Machine_learning_Algorithms_from_First_Principles/2. Unsupervised_Learning/02. Hierarchical_Clustering_mall_dataset"
```
