...
```
04. DBSCAN_online_retail_dataset/
├── notebook/
...
cd "Implementing_Machine_learning_Algorithms_from_First_Principles/2. Unsupervised_Learning/04. DBSCAN_online_retail_dataset"
```
